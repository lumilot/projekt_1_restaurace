...
public class CookBook {
    ...
    public static class GetFood {
        public GetFood loadDish(String FoodList) throws GetFoodException {
            int lineCounter = 0;
            try (Scanner scanner = new Scanner(new BufferedReader(new FileReader(FoodList)))) {
                while (scanner.hasNextLine()) {
                    ...
                    if (parts.length != 5) throw new GetFoodException(
                ...
                throw new GetFoodException("File " +FoodList+ " was not found\n"+ e.getLocalizedMessage());
            }
    ...
    public static void addDish(String fileName, Dish[] dishes) throws GetFoodException {
        int lineCounter = 0;
        ...
        try (PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter(fileName)))) {
            ...
            throw new GetFoodException(" File " +fileName+ " was not found.\n" + e.getLocalizedMessage());
        } catch (IOException e) {
